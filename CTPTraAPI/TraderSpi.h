/*
 * @Author: LeiJiulong
 * @Date: 2024-10-20 17:22:43
 * @LastEditors: LeiJiulong && lei15557570906@outlook.com
 * @LastEditTime: 2024-10-20 21:44:38
 * @Description:
 */
#pragma once
#include <string>
...
{
public:
    TraderSpi(const UserTraderLoginMsg &userLM) : login_info(userLM) {};
    ~TraderSpi();
    // ---- ctp_api部分回调接口 ---- //
public:
...
private:
    ...
    UserTraderLoginMsg login_info;
    CThostFtdcTraderApi *g_pTradeUserApi{}; //交易实例
